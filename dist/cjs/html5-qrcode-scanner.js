...
var Html5QrcodeScanner = (function () {
    function Html5QrcodeScanner(elementOrId, config, verbose) {
    ...
    Html5QrcodeScanner.prototype.render = function (qrCodeSuccessCallback, qrCodeErrorCallback) {
        ...
        this.html5Qrcode = new html5_qrcode_1.Html5Qrcode(this.qrCodeScanRegion, toHtml5QrcodeFullConfig(this.config, this.verbose));
    };
    ...
    Html5QrcodeScanner.prototype.clear = function () {
        ...
        var emptyHtmlContainer = function () {
            if (_this.container) {
                ...
                _this.resetBasicLayout(_this.container);
            }
        };
        if (this.html5Qrcode) {
    ...
    Html5QrcodeScanner.prototype.applyVideoConstraints = function (videoConstraints) {
        return this.getHtml5QrcodeOrFail().applyVideoConstraints(videoConstraints);
    };
    Html5QrcodeScanner.prototype.validateInputAsStringId = function (elementId) {
    ...
    Html5QrcodeScanner.prototype.validateInputAsHTMLElement = function (element) {
    ...
    Html5QrcodeScanner.prototype.renderCameraSelection = function (cameras) {
        ...
        var cameraZoomUi = camera_zoom_ui_1.CameraZoomUi.create(this.scpCameraScanRegion, false);
        ...
        var cameraSelectUi = camera_selection_ui_1.CameraSelectionUi.create(this.scpCameraScanRegion, cameras);
    ...
    Html5QrcodeScanner.prototype.createSectionSwap = function () {
        ...
        this.switchScanTypeLink
            = base_1.BaseUiElementFactory.createElement("span", this.getDashboardSectionSwapLinkId());
    ...
    Html5QrcodeScanner.prototype.insertCameraScanImageToScanRegion = function () {
        ...
        this.cameraScanImage.onload = function (_) {
            _this.qrCodeScanRegion.innerHTML = "<br>";
            _this.qrCodeScanRegion.appendChild($this.cameraScanImage);
        };
    ...
    Html5QrcodeScanner.prototype.insertFileScanImageToScanRegion = function () {
        ...
        this.fileScanImage.onload = function (_) {
            _this.qrCodeScanRegion.innerHTML = "<br>";
            _this.qrCodeScanRegion.appendChild($this.fileScanImage);
        };
