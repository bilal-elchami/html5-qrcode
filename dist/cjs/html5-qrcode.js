...
var Html5Qrcode = (function () {
    function Html5Qrcode(element, configOrVerbosityFlag) {
    ...
    Html5Qrcode.prototype.stop = function () {
        ...
        var removeQrRegion = function () {
            ...
            if (_this.shadingElement) {
                _this.element.removeChild(_this.shadingElement);
            }
        };
        var $this = this;
    ...
    Html5Qrcode.prototype.scanFileV2 = function (imageFile, showImage) {
        ...
        return new Promise(function (resolve, reject) {
            ...
            inputImage.onload = function () {
                ...
                var containerWidth = _this.element.clientWidth
                    ? _this.element.clientWidth : Constants.DEFAULT_WIDTH;
                var containerHeight = Math.max(_this.element.clientHeight ? _this.element.clientHeight : imageHeight, Constants.FILE_SCAN_MIN_HEIGHT);
                ...
                if (showImage) {
                    ...
                    _this.element.appendChild(visibleCanvas);
                ...
                _this.element.appendChild(hiddenCanvas);
    ...
    Html5Qrcode.prototype.possiblyInsertShadingElement = function (element, width, height, qrboxSize) {
        ...
        this.shadingElement.id = "".concat(Constants.SHADED_REGION_ELEMENT_ID);
        if ((width - qrboxSize.width) < 11
            ...
            var smallSize = 5;
            var largeSize = 40;
            this.insertShaderBorders(this.shadingElement, largeSize, smallSize, -smallSize, null, 0, true);
            this.insertShaderBorders(this.shadingElement, largeSize, smallSize, -smallSize, null, 0, false);
            this.insertShaderBorders(this.shadingElement, largeSize, smallSize, null, -smallSize, 0, true);
            this.insertShaderBorders(this.shadingElement, largeSize, smallSize, null, -smallSize, 0, false);
            this.insertShaderBorders(this.shadingElement, smallSize, largeSize + smallSize, -smallSize, null, -smallSize, true);
            this.insertShaderBorders(this.shadingElement, smallSize, largeSize + smallSize, null, -smallSize, -smallSize, true);
            this.insertShaderBorders(this.shadingElement, smallSize, largeSize + smallSize, -smallSize, null, -smallSize, false);
            this.insertShaderBorders(this.shadingElement, smallSize, largeSize + smallSize, null, -smallSize, -smallSize, false);
