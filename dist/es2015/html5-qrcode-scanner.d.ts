...
export declare class Html5QrcodeScanner {
    ...
    private scpCameraScanRegion;
    private dashboardSection;
    private permissionButton;
    private headerMessageContainer;
    private qrCodeScanRegion;
    private switchScanTypeLink;
    constructor(elementId: string, config: Html5QrcodeScannerConfig | undefined, verbose: boolean | undefined);
    constructor(element: HTMLElement, config: Html5QrcodeScannerConfig | undefined, verbose: boolean | undefined);
    ...
    private validateInputAsStringId;
    private validateInputAsHTMLElement;
